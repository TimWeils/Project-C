...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton Tab = new InputButton(KeyCode.Tab, XboxControllerButtons.None);
        public InputButton One = new InputButton(KeyCode.Alpha1, XboxControllerButtons.None);
        ...
        protected override void GetInputs(bool fixedUpdateHappened)
        {
            ...
            One.Get(fixedUpdateHappened, inputType);
        ...
        public override void ReleaseControl(bool resetValues = true)
        {
            ...
            ReleaseControl(One, resetValues);
